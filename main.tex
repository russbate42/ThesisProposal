...
\setlength{\parindent}{10pt}   % Remove paragraph indentation
% \setlength{\intextsep}{0.5\baselineskip}

%% Wrap figure formatting
\setlength{\intextsep}{6pt}     % Space above and below
% \setlength{\columnsep}{8pt}     % Space between figure and text
\setlength{\wrapoverhang}{0pt}  % Overhang into margin
...
% subdetector complementarity. Add citation for LCW
...
statistical fitting framework. %This has been done with a command line interface
...
% central production. Throughout the winter semester, the analysis team and I
% can finalize the background estimate. During this time I can combine the
% statistical analysis for Run 2 and Run 3. That leaves an editorial board
% request for the end of the fall 2025 semester, or the winter semester of 2026.
% The iterations with the editorial board, and the internal ATLAS will take the
% semester. I propose to have my thesis ready for application to graduate by the
...
\begin{table}[h]
    \centering
    \begin{tabular*}{.8\textwidth}{l@{\extracolsep{\fill}}c}%{ l c }
        ...
        Cosmology & \\ \hline
    \end{tabular*} 
    % \caption{\parbox{12cm}{\centering Courses taken as a graduate student at the
    %         University of British Columbia, as an undergraduate at the
    %         University of Calgary, and transferred from a masters at the University
    %         of Amsterdam.}}
